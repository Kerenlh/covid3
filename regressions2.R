# create_details = function(parallel_num){
  ...
  #         "codon.c_backwords", "R.neighbor_backwords","L.neighbor","R.neighbor",
  #         "L.neighbor","codon","amino_acid","amino_acid","CG")
  ...
  input = c("L.neighbor","R.neighbor","mat_peptide","codon","site","codon.pos",
            "gene","CG",
            "amino_acid","exposure","syn_exposure","non_syn_exposure")             
  ...
  #           "codon",
  #           "R.neighbor","L.neighbor",
  #           "exposure","syn_exposure","non_syn_exposure")
  # input_iterate = c("codon.pos","backwords","CG","codon","amino_acid",
  #                   "R.neighbor","L.neighbor","regions","regions2")
  # 
  # data = data.codon_nbs
  input_iterate = c("L.neighbor","R.neighbor","mat_peptide","codon","codon.pos",
                    "gene","CG","amino_acid")
  data = codons_table
  ...
  file_name = paste0("details.codon.65.region.15.output.",parallel_num,collapse = "")
  # setwd("C:\\Users\\user\\Dropbox\\mtDNA_tree_Build_17\\all_details6")
  setwd("C:\\Users\\Keren\\Dropbox\\mtDNA_tree_Build_17\\all_details6")
